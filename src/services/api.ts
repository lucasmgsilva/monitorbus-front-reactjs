...
const Api = {
    getRoute: async (route_id: string) => {
        const response = await axiosInstance.get(`/routes/${route_id}`);
        return await response.data;
    },
    getTravel: async (travel_id: string) => {
        const response = await axiosInstance.get(`/travels/${travel_id}`);
        return await response.data;
    },
    getCurrentLocationByTravelID: async (travel_id: string) => {

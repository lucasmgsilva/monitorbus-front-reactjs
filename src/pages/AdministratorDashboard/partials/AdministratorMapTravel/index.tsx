...
import { MapContainer, MapControls, TravelTitle, AdministratorMapTravelSection } from "./styled";
...
 
    ...
    return (
        <>
            <AdministratorMapTravelSection>
                <Container>
                    <TravelTitle>Meus Ônibus</TravelTitle>
...
export default AdministratorMapTravel;